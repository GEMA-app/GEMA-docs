...
# Guía para crear un endpoint en GEMA Backend
...
Si el módulo es nuevo (preferences), hay que crear los siguientes archivos.

> **Recordatorio:** cada nuevo módulo del dominio debe crear sus excepciones, value objects (si aplica) y entidad. No importa qué tan simple sea el recurso. El dominio es el núcleo: si no está bien definido a este nivel, el resto de capas arrastran el problema.
...
> **Clase pura de Python — qué significa exactamente:**
>
> Una "clase pura de Python" usa exclusivamente la biblioteca estándar (`dataclasses`, `datetime`, `uuid`, `enum`, `typing`). No importa nada de terceros:
...
> **📖 5W1H: Entidad anémica vs Entidad rica**
...
### Capa 2 — Application: `src/app/application/`
...
> **📖 5W1H: Interface (Protocol) — concepto**
>
> | Pregunta | Respuesta |
> |----------|-----------|
...
### Capa 3 — Infrastructure: `src/app/infrastructure/`
...
> **📖 5W1H: Mapping ORM ↔ Entidad de dominio**
>
...
### Capa 5 — Composition: `src/app/composition/container/`
...
> ```
> Endpoint
>   └─ Depends(provide_user_preferences_use_case)     ← Composition
>        └─ Depends(get_uow)                           ← Composition/common.py
>             └─ SqlAlchemyUnitOfWork(                  ← Infrastructure
>                  event_bus=LoggingEventBus()
>                )
>                  └─ .preferences = SqlAlchemyPreferenceRepository(...)  ← Infrastructure
>                       └─ implements PreferenceRepositoryPort            ← Application/Ports
> ```
