...
<Files>
  <Folder name="src/app/domain" defaultOpen>
    <File name="__init__.py" icon="python" />
    <File name="enums.py" icon="python" />
    <File name="events.py" icon="python" />
    <Folder name="entities" defaultOpen>
      <File name="__init__.py" icon="python" />
      <File name="preference.py" icon="python" />
    </Folder>
...
```bash
git commit -m "feat(backend): agregar entidad y excepciones de preferencias"
```
</Callout>
...
<Files>
  <Folder name="src/app/application" defaultOpen>
    <Folder name="dtos" defaultOpen>
      <File name="preference_dtos.py" icon="python" />
    </Folder>
    <Folder name="ports" defaultOpen>
      <File name="preference_repository.py" icon="python" />
      <File name="unit_of_work.py" icon="python" />
    </Folder>
    <Folder name="use_cases" defaultOpen>
      <Folder name="preference" defaultOpen>
        <File name="__init__.py" icon="python" />
        <File name="get_user_preference.py" icon="python" />
        <File name="update_user_preference.py" icon="python" />
      </Folder>
    </Folder>
  </Folder>
</Files>
...
**Ejemplo de commit para esta capa:**
```bash
git commit -m "feat(backend): crear casos de uso y dtos para preferencias"
```
</Callout>
...
**Ejemplo de commit para esta capa:**
```bash
git commit -m "feat(backend): implementar modelo orm y repositorio de preferencias"
```
</Callout>
    ...
    <Folder name="api" defaultOpen>
      <Folder name="v1" defaultOpen>
        <Folder name="endpoints" defaultOpen>
          <File name="preferences.py" icon="python" />
        </Folder>
        <Folder name="schemas" defaultOpen>
          <File name="preferences.py" icon="python" />
        </Folder>
        <File name="router.py" icon="python" />
      </Folder>
    </Folder>
    <Folder name="exception_handlers" defaultOpen>
      <File name="domain.py" icon="python" />
    </Folder>
  </Folder>
</Files>
...
**Ejemplo de commit para esta capa:**
```bash
git commit -m "feat(backend): agregar endpoint de FastAPI y schemas jsonapi"
```
</Callout>
...
**Ejemplo de commit para esta capa:**
```bash
git commit -m "feat(backend): registrar fabricas de dependencias y configurar router"
```
</Callout>
